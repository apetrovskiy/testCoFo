from src.main.java.testCoFo.events.e695.SumOfPaths.sum_of_paths import sum_of_paths
import pytest
...
test_data = [
    ...
    ([4, 40, 6], [92, 21, 82, 46], [[3, 56], [1, 72], [4, 28], [1, 97], [2, 49], [
     2, 88]], [239185261, 666314041, 50729936, 516818968, 766409450, 756910476])
]
