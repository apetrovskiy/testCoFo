from src.main.java.testCoFo.problems.FourSegments.four_segments import four_segments
...
def test_four_segments(number_of_cases: int, cases: List[List[int]], expected_result: List[int]):
